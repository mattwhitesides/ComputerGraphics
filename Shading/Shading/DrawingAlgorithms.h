...
public:
    ...
    */
    ...
    /*<<<<<<<<<<<<<<<<<<drawCircle>>>>>>>>>>>>>>>
    Draws a circle using the midpoint circle algorithem
    Input:
      int xa - the x coord of the start point
      int ya - the y coord of the start point
      int xb - the x coord of the end point
    ...
    */
    ...
    /*<<<<<<<<<<<<<<<<<<drawEllipse>>>>>>>>>>>>>>>
    Draws a ellipse using the midpoint ellipse algorithem
    Input:
      int xa - the x coord of the start point
      int ya - the y coord of the start point
      int xR - the length of the x radius
      int yR - the length of the y radius
    Return:
        A Vector List of Strings based on the output of the algorithem
    */
    static QVector<QString> drawEllipse(int x, int y, int xR, int yR);
